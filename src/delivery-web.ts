...
} from "./delivery-web-parallel-workspace-radar.js";
import {
...
function directoryPage(): string {
  return `<main class="directory-page" aria-label="Feature demos">
    <section class="feature-directory" aria-label="Available feature demos">
      ...
      <a class="directory-card radar-card" href="/parallel-workspace-radar">
        <div class="card-copy">
          <span class="card-kicker"><i></i>Parallel execution</span>
          <h2>Workspace Radar</h2>
          <p>See isolated worktrees, active agents, handoffs, and merge-path risk as one live topology.</p>
          <ul><li>Spatial agent topology</li><li>Workspace lease state</li><li>Conflict forecasting</li></ul>
          <span class="open-page">Open feature page <b>→</b></span>
        </div>
...
function remoteControlPage(): string {
  return `<main class="feature-page remote-feature-page">
...
function dynamicWorkflowPage(): string {
  return `<main class="feature-page workflow-feature-page">
    <section class="feature-layout">
      <div class="demo-surface">
        <div class="surface-toolbar">
...
.remote-feature-page .feature-layout,.workflow-feature-page .feature-layout{display:block}.remote-feature-page .surface-toolbar,.remote-feature-page .feature-notes,.workflow-feature-page .surface-toolbar,.workflow-feature-page .feature-notes,.workflow-feature-page .canvas-toolbar,.workflow-feature-page .event-ledger{display:none}.remote-feature-page .demo-surface,.workflow-feature-page .demo-surface{border:0}.remote-feature-page .remote-console{min-height:100vh;grid-template-columns:minmax(280px,25vw) minmax(0,1fr)}.remote-feature-page .phone-link-panel{justify-content:center}.remote-feature-page .phone-device{width:166px;height:340px}.remote-feature-page .live-viewport{min-height:100vh}.workflow-feature-page .workflow-console,.workflow-feature-page .workflow-canvas,.workflow-feature-page .workflow-board{width:100%;height:100vh;min-height:100vh}.workflow-feature-page .workflow-canvas{overflow:hidden}.workflow-feature-page .workflow-links{width:100%;height:100%}.workflow-feature-page .workflow-node{width:11.76%;min-height:20vh;padding:clamp(14px,1.5vw,28px);transform:translateY(-50%)}.workflow-feature-page .trigger-node{top:50%;left:1.47%;width:10.29%}.workflow-feature-page .context-node{top:50%;left:17.15%}.workflow-feature-page .router-node{top:50%;left:34.31%}.workflow-feature-page .build-node{top:25%;left:51.47%}.workflow-feature-page .verify-node{top:75%;left:51.47%}.workflow-feature-page .approval-node{top:50%;left:68.63%}.workflow-feature-page .delivery-node{top:50%;left:85.78%;width:12.75%}.workflow-feature-page .node-port{top:50%;transform:translateY(-50%)}.workflow-feature-page .node-icon{width:clamp(28px,3vw,52px);height:clamp(28px,3vw,52px);margin-bottom:clamp(14px,2vw,28px);font-size:clamp(9px,1vw,16px)}.workflow-feature-page .workflow-node small{font-size:clamp(6px,.55vw,10px)}.workflow-feature-page .workflow-node strong{font-size:clamp(9px,.95vw,17px)}.workflow-feature-page .workflow-node p{font-size:clamp(7px,.65vw,12px)}.workflow-feature-page .node-state{right:clamp(10px,1vw,18px);bottom:clamp(10px,1vw,18px);font-size:clamp(7px,.6vw,11px)}
